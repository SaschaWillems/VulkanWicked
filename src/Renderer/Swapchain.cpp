...
Swapchain::Swapchain(VkInstance instance, VkDevice device, VkPhysicalDevice physicalDevice)
{
...
void Swapchain::initSurface(SDL_Window* window)
{
	if (!SDL_Vulkan_CreateSurface(window, (SDL_vulkanInstance)instance, (SDL_vulkanSurface*)&surface)) {
		vks::tools::exitFatal("Could not create surface!", -1);
	}
